    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImpressionType", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Modell", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Modell_Brand_BrandId",
                        column: x => x.BrandId,
                        principalTable: "Brand",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Modell_Modell_ParentModelId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RigesterDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubmitEditTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    StatusId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Product_Modell_ModelId",
                        column: x => x.ModelId,
                        principalTable: "Modell",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationRoleUsers", x => new { x.UserId, x.RoleId });
                    table.ForeignKey(
                        name: "FK_ApplicationRoleUsers_ApplicationRole_RoleId",
                        column: x => x.RoleId,
                        principalTable: "ApplicationRole",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ApplicationRoleUsers_ApplicationUser_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DispatchNumber = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TextComment = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comment_ApplicationUser_SubmitUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductCollections", x => new { x.CollectionsId, x.ProductsId });
                    table.ForeignKey(
                        name: "FK_ProductCollections_Collection_CollectionsId",
                        column: x => x.CollectionsId,
                        principalTable: "Collection",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductCollections_Product_ProductsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProductFile_TypeFile_FileTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductView_ApplicationUser_ViewerUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProductOrder_Product_PrductId",
                        column: x => x.PrductId,
                        principalTable: "Product",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentImpression", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CommentImpression_ApplicationUser_SubmmitUserId",
                        column: x => x.SubmmitUserId,
                        principalTable: "ApplicationUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommentImpression_Comment_CommentId",
                        column: x => x.CommentId,
                        principalTable: "Comment",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CommentImpression_ImpressionType_ImpressionTypeId",
                        column: x => x.ImpressionTypeId,
                        principalTable: "ImpressionType",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationRoleUsers_RoleId",
                table: "ApplicationRoleUsers",
                column: "RoleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comment_SubmitUserId",
                table: "Comment",
                column: "SubmitUserId");

            migrationBuilder.CreateIndex(
                name: "IX_CommentImpression_CommentId",
                table: "CommentImpression",
                column: "CommentId");

            migrationBuilder.CreateIndex(
                name: "IX_CommentImpression_ImpressionTypeId",
                table: "CommentImpression",
                column: "ImpressionTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_CommentImpression_SubmmitUserId",
                table: "CommentImpression",
                column: "SubmmitUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Modell_BrandId",
                table: "Modell",
                column: "BrandId");

            migrationBuilder.CreateIndex(
                name: "IX_Modell_ParentModelId",
                table: "Modell",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductFile_FileTypeId",
                table: "ProductFile",
                column: "FileTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductView_ViewerUserId",
                table: "ProductView",
                column: "ViewerUserId");
